#!/usr/bin/env bash
rrdtool xport -s now-3h -e now --step 60 --json \
...
XPORT:c:"Load 15 min average" > ../data/rrd_system_load_3h.json
...
XPORT:e:"zom" \
XPORT:f:"stp" \
XPORT:g:"Processes swap" > ../data/rrd_system_processor_3h.json
...
XPORT:f:"Memory inactive" > ../data/rrd_system_memory_3h.json
...
XPORT:c:"C" \
XPORT:d:"D" \
XPORT:e:"E" > ../data/rrd_system_val_3h.json
