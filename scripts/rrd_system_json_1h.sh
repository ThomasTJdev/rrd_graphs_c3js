...
XPORT:c:"Load 15 min average" > ../data/rrd_system_load_1h.json
...
XPORT:e:"zom" \
XPORT:f:"stp" \
XPORT:g:"Processes swap" > ../data/rrd_system_processor_1h.json
...
XPORT:f:"Memory inactive" > ../data/rrd_system_memory_1h.json
...
XPORT:c:"C" \
XPORT:d:"D" \
XPORT:e:"E" > ../data/rrd_system_val_1h.json
